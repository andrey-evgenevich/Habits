...
#         user = User.objects.create_user(username="telegramuser", password="testpass")
...
#             "/api/users/token/", {"username": "testuser", "password": "testpass123"}
#         )
...
#             {"telegram_token": token, "chat_id": "12345"},
#             format="json",
#         )
#
#         self.assertEqual(response.status_code, status.HTTP_200_OK)
